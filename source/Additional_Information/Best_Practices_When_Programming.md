...
You can also free up the memory associated with an array by setting the
...
-   [The Hazards Of Precise Collision
...
comes into play... This function can be called before you create a
